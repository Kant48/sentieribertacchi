...
@app.route("/")
def mappa():
    lat = 45.4642  # Valori di esempio
    lng = 9.1900
    return render_template("mappa.html", latitude=lat, longitudine=lng)
...
<html>
  <head>  
<script>
  console.log("Latitude:", {{ latitude|tojson }});
  console.log("Longitudine:", {{ longitudine|tojson }});
</script>
...
<script>
  ...
  var longitudine = {{ longitudine|tojson }};
