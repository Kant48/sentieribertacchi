...
# Dati dei rifugi e sentieri (manteniamo la tua logica)
rifugi = [
    {
...
# Creazione del codice HTML per la mappa di Google Maps con i marker
map_html = f"""
<!DOCTYPE html>
<html>
  <head>
    ...
    <script>
      function initMap() {{
        ...
        // Aggiungi i marker per ogni rifugio
        ...
        rifugi.forEach(function(rifugio) {{
          ...
          rifugio.sentieri.forEach(function(sentiero) {{
            var percorso = sentiero.coordinata;
