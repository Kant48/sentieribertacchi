...
<html>
  ...
  <body>
    ...
    <div class="legend">
      <h3>Legenda</h3>
      <div><span style="background-color: red;"></span>Difficoltà Alta</div>
      <div><span style="background-color: yellow;"></span>Difficoltà Media</div>
      <div><span style="background-color: green;"></span>Difficoltà Facile</div>
    </div>
