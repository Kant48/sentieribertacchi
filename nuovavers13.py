...
# Mostra le note generali in sovrapposizione se attivato
...
# Mostra le note generali sopra la mappa solo se attivate
if st.session_state["mostra_note"]:
	# Div HTML per la sovrapposizione delle note
	st.markdown(f"""
